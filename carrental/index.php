...
<main class="index-main"> 
    ...
    <section class="fleet index-fleet" id="fleet"> 
        <div class="container">
            <h2>Our Fleet</h2>
    ...
    <section class="services index-services" id="services"> 
        <div class="container">
            <h2>Our Services</h2>
    ...
    <div class="details-section">
        <div class="location-details location-card">
            <h2>Kitchener</h2>
    ...
    <section class="contact index-contact" id="contact"> 
        <div class="container">
            <h2>Contact Us</h2>
